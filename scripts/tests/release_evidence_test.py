...
def release_fixture(tmp_path: Path) -> dict[str, object]:
    ...
    files = {
        ...
        "deploy/systemd/trex-webui-release-consumer-ack-v1-bridge-v2.conf": b"[Service]\nExecStart=\nExecStart=/usr/bin/true\n",
        "deploy/systemd/trex-webui-release-consumer-ack-v2.service": b"[Service]\nExecStart=/bin/true\n",
        "deploy/systemd/trex-webui-release-reconcile.service": b"[Service]\n",
        "deploy/systemd/trex-webui-release-reconcile-v1-bridge-v2.conf": b"[Service]\nExecStart=\nExecStart=/usr/bin/true\n",
        "deploy/systemd/trex-webui-release-reconcile-v2.conf": b"[Unit]\nRequires=trex-webui-release-reconcile-v2.service\nAfter=trex-webui-release-reconcile-v2.service\n",
        "deploy/systemd/trex-webui-release-reconcile-v2.service": b"[Service]\nExecStart=/bin/true\n",
        "deploy/systemd/trex-webui-release-retry.service": b"[Service]\n",
        "deploy/systemd/trex-webui-release-retry-v1-bridge-v2.conf": b"[Service]\nExecStart=\nExecStart=/usr/bin/true\n",
        "deploy/systemd/trex-webui-release-retry-v2.service": b"[Service]\nExecStart=/bin/true\n",
